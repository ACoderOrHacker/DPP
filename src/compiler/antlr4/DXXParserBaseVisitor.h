...
public:
  ...
  virtual std::any visitTypedefExpr(DXXParser::TypedefExprContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitFunctionCallExprTag(DXXParser::FunctionCallExprTagContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitIncDecExpr(DXXParser::IncDecExprContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitNewExpr_(DXXParser::NewExpr_Context *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitDeleteExpr_(DXXParser::DeleteExpr_Context *ctx) override {
    return visitChildren(ctx);
  }
