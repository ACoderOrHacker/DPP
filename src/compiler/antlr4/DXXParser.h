...
public:
  ...
  enum {
    ...
    RuleFunctionCall = 17, RuleParamList = 18, RuleCallParamList = 19, RuleThrowtable = 20, 
    RuleVarDefine = 21, RuleVarDefineNoSet = 22, RuleVarSet = 23, RuleWithStatement = 24, 
    RuleWithIf = 25, RuleWithIfExtends = 26, RuleWithIfExtendsSub = 27, 
    RuleWithSwitchStatement = 28, RuleCaseStatement = 29, RuleDefaultStatement = 30, 
    RuleWhileLoop = 31, RuleDoWhileLoop = 32, RuleForeachLoop = 33, RuleGoto = 34, 
    RuleGotoLabelDefine = 35, RuleEnum = 36, RuleEnumSub = 37, RuleClass = 38, 
    RuleInterface = 39, RuleClassMethods = 40, RuleInterfaceMethods = 41, 
    RuleOperatorDefine = 42, RuleBlock = 43, RuleTry = 44, RuleThrow = 45, 
    RuleTheType = 46, RuleTheTypeSub = 47, RuleIdEx = 48, RuleInfo = 49, 
    RuleNative = 50, RuleAssigns = 51, RuleAllOperators = 52
  };
  ...
  class  FunctionDefineExprContext : public GExpressionsContext {
  public:
    FunctionDefineExprContext(GExpressionsContext *ctx);
