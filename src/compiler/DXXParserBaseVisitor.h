...
public:
  ...
  virtual std::any visitVoidExpr(DXXParser::VoidExprContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitQuestionExpr(DXXParser::QuestionExprContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitIfStatementExpr(DXXParser::IfStatementExprContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitConvertExpr(DXXParser::ConvertExprContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitSwitchStatementExpr(DXXParser::SwitchStatementExprContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitOperatorDefineExpr(DXXParser::OperatorDefineExprContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitIfStatement(DXXParser::IfStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitSwitchStatement(DXXParser::SwitchStatementContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitEnumList(DXXParser::EnumListContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitTemplateList(DXXParser::TemplateListContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitCallTemplateList(DXXParser::CallTemplateListContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitTemplateListSub(DXXParser::TemplateListSubContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitCallTemplateSub(DXXParser::CallTemplateSubContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitTrySub(DXXParser::TrySubContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitCatchSub(DXXParser::CatchSubContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitFinallySub(DXXParser::FinallySubContext *ctx) override {
    return visitChildren(ctx);
  }
