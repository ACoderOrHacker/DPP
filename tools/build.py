...
def build():
    ...
    if os.system("cmake --build . --target package") != 0 or os.system("cmake --build . --target package_source") != 0:
        bad_build()
...
def main():
    global build_type, is_debug, vcpkg_root, no_vcpkg_root, build_dir
